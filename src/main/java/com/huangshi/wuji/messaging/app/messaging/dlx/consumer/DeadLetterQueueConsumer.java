package com.huangshi.wuji.messaging.app.messaging.dlx.consumer;
...
public class DeadLetterQueueConsumer {
    ...
    @RabbitListener(queues = RabbitMQConfigForTTLDLX.DEAD_LETTER_QUEUEA_NAME)
    ...
    @RabbitListener(queues = RabbitMQConfigForTTLDLX.DEAD_LETTER_QUEUEB_NAME)
    ...
    @RabbitListener(queues = RabbitMQConfigForTTLDLX.DEAD_LETTER_QUEUEC_NAME)
